                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="editmain.php?id=<?= $objResult[id]; ?>" method="post" enctype="multipart/form-data">
                                <p>
                                    <?
                                    $strSQL = "SELECT * FROM  `homeV3` where id=$_GET[id]  ";
                                    $objQuery = mysql_query($strSQL) or die ("Error Query [".$strSQL."]");
                                    while($objResult = mysql_fetch_array($objQuery)){
                                    echo $objResult[readmore]." <a href=\"main.php?id=$objResult[id]\">แก้ไข</a><br>";
                                ...
                                <div class="form-group">
                                    <label>
                                        เนื้อหา
                                        <textarea name="contentHomeSlide" class="form-control" cols="50" rows="5"><?= $objResult[contentHomeSlide]; ?>
                                        </textarea>
                                    </label>
                                </div>
